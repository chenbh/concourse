...
func (fake *FakeImageFetchingDelegate) RedactImageSource(arg1 types.Source) (types.Source, error) {
...
func (fake *FakeImageFetchingDelegate) RedactImageSourceCalls(stub func(types.Source) (types.Source, error)) {
	fake.redactImageSourceMutex.Lock()
	defer fake.redactImageSourceMutex.Unlock()
	fake.RedactImageSourceStub = stub
}

func (fake *FakeImageFetchingDelegate) RedactImageSourceArgsForCall(i int) types.Source {
	fake.redactImageSourceMutex.RLock()
	defer fake.redactImageSourceMutex.RUnlock()
...
func (fake *FakeImageFetchingDelegate) RedactImageSourceReturns(result1 types.Source, result2 error) {
	fake.redactImageSourceMutex.Lock()
	defer fake.redactImageSourceMutex.Unlock()
...
func (fake *FakeImageFetchingDelegate) RedactImageSourceReturnsOnCall(i int, result1 types.Source, result2 error) {
	fake.redactImageSourceMutex.Lock()
	defer fake.redactImageSourceMutex.Unlock()
	fake.RedactImageSourceStub = nil
